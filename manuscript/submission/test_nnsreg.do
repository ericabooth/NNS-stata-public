...
graph export "fig_edu_fits.pdf", replace
graph export "fig_edu_fits.png", replace width(2200)
...
graph export "fig_edu_coef.pdf", replace
graph export "fig_edu_coef.png", replace width(2000)
...
tempname fh
file open `fh' using "table_postest.csv", write replace
...
graph export "fig_edu_sensitivity.pdf", replace
graph export "fig_edu_sensitivity.png", replace width(2000)
...
graph export "fig_water_fits.pdf", replace
graph export "fig_water_fits.png", replace width(2200)
...
graph export "fig_water_knots.pdf", replace
graph export "fig_water_knots.png", replace width(2000)
...
graph export "fig_water_sensitivity.pdf", replace
graph export "fig_water_sensitivity.png", replace width(2000)
...
use "clustered_peak_dip.dta", clear
...
graph export "fig_cluster_fits.pdf", replace
graph export "fig_cluster_fits.png", replace width(2200)
...
graph export "fig_cluster_sensitivity.pdf", replace
graph export "fig_cluster_sensitivity.png", replace width(2000)
...
postfile `mc' str14 design int rep str8 mcode str24 model ///
    double(r2 rmse_obs rmse_true) using "mc_results.dta", replace
...
export delimited design model mean_rmse_true sd_rmse_true mean_rmse_obs ///
    share_beats_kernel reps using "table_mc_summary.csv", replace
...
graph export "fig_mc_rmse.pdf", replace
graph export "fig_mc_rmse.png", replace width(2400)
...
use "model_diagnostics.dta", clear
format r2 %6.3f
format rmse_obs rmse_true %6.3f
export delimited using "table_model_diagnostics.csv", replace
list, sepby(example)
